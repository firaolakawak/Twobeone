...
export function PartnerChat({ accessToken, currentUserId, partnerName = 'Partner', partnerOnline = false, onBack, onUnreadChange }: PartnerChatProps) {
  ...
  return (
    <section onPointerDown={primeMessageSound} onKeyDown={primeMessageSound} className="mx-auto flex min-h-[calc(100dvh-10rem)] w-full max-w-2xl flex-col overflow-hidden rounded-[2rem] border border-rose-100 bg-white shadow-[0_24px_70px_-48px_rgba(190,24,93,.6)]" aria-label={text.title}>
      <header className="relative overflow-hidden border-b border-rose-100 bg-gradient-to-br from-rose-600 to-rose-700 px-5 py-5 text-white">
        ...
        <div className="relative flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1"><h1 className="tbo-h2 break-words">{partnerName}</h1><p className="tbo-caption text-rose-50">{partnerOnline ? text.online : text.offline}</p></div>
