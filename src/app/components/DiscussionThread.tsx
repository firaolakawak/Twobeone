...
export function DiscussionThread({
  ...
  return (
    <Card className="tbo-glass border-2 border-border shadow-md bg-card overflow-hidden">
      {/* Discussion Header */}
      <div className="px-6 py-4 bg-[var(--glass-inset-surface)] border-b border-border">
