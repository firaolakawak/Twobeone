          ...
          <div className="relative mx-auto flex w-full max-w-3xl flex-wrap items-start gap-3 sm:gap-5">
            ...
            <div className="min-w-0 flex-1 basis-48">
              <div className="mb-2 flex flex-wrap items-center gap-2">
                <span className="tbo-eyebrow inline-flex items-center gap-1.5 rounded-full bg-white/80 px-2.5 py-1 text-rose-700 shadow-sm ring-1 ring-rose-100">
              ...
              <DialogTitle className="tbo-dialog-title break-words text-slate-950">{devotional.title}</DialogTitle>
              <p className="tbo-supporting mt-1 hidden max-w-xl text-slate-500 sm:block">
            ...
            <section className="rounded-[1.5rem] bg-white p-6 shadow-[0_14px_45px_-34px_rgba(15,23,42,0.55)] ring-1 ring-slate-200/70 sm:p-7">
              <div className="mb-5 flex items-center gap-3">
                ...
                <div>
                  ...
                  <h3 className="tbo-card-title mt-0.5 text-slate-900">{t.devotionals.dailyReflection}</h3>
                </div>
              </div>
                ...
                <>
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <h3 className="tbo-card-title text-slate-900">{tr("Reflect together")}</h3>
                    </div>
                  </div>
                  <PrayerTogetherChat
              ...
              <section className="rounded-[1.5rem] bg-white p-6 shadow-[0_14px_45px_-34px_rgba(15,23,42,0.55)] ring-1 ring-slate-200/70 sm:p-7">
                <div className="mb-5 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <h3 className="tbo-card-title text-slate-900">{t.devotionals.audioTab}</h3>
                  </div>
                </div>
                <div>
                  {audioError ? (
                    <div className="text-center py-8">
                      ...
                      <p className="tbo-supporting mb-1 text-slate-700">{tr("Audio unavailable")}</p>
                      <p className="tbo-caption text-slate-500">{tr("The audio format may not be supported by your browser.")}</p>
                    </div>
                  ) : (
                    <>
                      <audio
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <button
                          type="button"
                          onClick={togglePlay}
                          className="tbo-action flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-rose-600 text-white shadow-lg shadow-rose-200 transition-all duration-200 hover:scale-105 hover:bg-rose-700 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-rose-200 motion-reduce:transform-none"
                      ...
                      <p className="tbo-caption mt-3 text-center text-slate-400">
        ...
        {onComplete && (
          <div className="flex-shrink-0 border-t border-slate-200 bg-white/95 p-4 shadow-[0_-12px_35px_-28px_rgba(15,23,42,0.35)] backdrop-blur sm:p-5">
            ...
            <Button
              ...
              className="tbo-action h-12 w-full rounded-full bg-rose-600 px-6 text-white shadow-lg shadow-rose-200 transition-all duration-200 hover:bg-rose-700 hover:shadow-xl disabled:bg-emerald-50 disabled:text-emerald-700 disabled:opacity-100 disabled:shadow-none sm:w-auto sm:min-w-56"
            >
