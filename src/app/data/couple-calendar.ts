...
export const coupleCalendarCopy: Record<Language, CalendarCopy> = {
  en: {
    ...
    syncedActivity: 'Synced couple activity', syncedActivityHint: 'Recorded faith and relationship moments marked on your calendar.', prayerActivity: 'Prayer', devotionalActivity: 'Devotional', qaActivity: 'Q&A', verseActivity: 'Shared verses', moodActivity: 'Daily moods', stageActivity: 'Couple stage', devotionalCompleted: 'Devotional completed', questionAnswered: 'Question answered', moodGreat: 'Feeling great', moodGood: 'Feeling good', moodOkay: 'Feeling okay', moodSad: 'Feeling sad', seedStage: 'Seed Stage', growthStage: 'Growth Stage', unityStage: 'Unity Stage', commitmentStage: 'Commitment Stage', covenantStage: 'Covenant Stage',
    ...
    reminderLabel: 'Remind us', atTime: 'At event time', fifteen: '15 minutes before', hour: 'Loud alarm — 1 hour before', day: '1 day before', noReminder: 'No reminder',
  ...
  am: {
    ...
    syncedActivity: 'የተመሳሰለ የጥንዶች እንቅስቃሴ', syncedActivityHint: 'የተመዘገቡ የእምነትና የግንኙነት ጊዜያት በቀን መቁጠሪያችሁ ላይ ይታያሉ።', prayerActivity: 'ጸሎት', devotionalActivity: 'የዕለት ተዕለት ንባብ', qaActivity: 'ጥያቄና መልስ', verseActivity: 'የተጋሩ ጥቅሶች', moodActivity: 'የዕለት ስሜት', stageActivity: 'የጥንዶች ደረጃ', devotionalCompleted: 'የዕለት ተዕለት ንባብ ተጠናቋል', questionAnswered: 'ጥያቄ ተመልሷል', moodGreat: 'በጣም ጥሩ ስሜት', moodGood: 'ጥሩ ስሜት', moodOkay: 'መካከለኛ ስሜት', moodSad: 'የሀዘን ስሜት', seedStage: 'የዘር ደረጃ', growthStage: 'የእድገት ደረጃ', unityStage: 'የአንድነት ደረጃ', commitmentStage: 'የቁርጠኝነት ደረጃ', covenantStage: 'የቃል ኪዳን ደረጃ',
    ...
    reminderLabel: 'አስታውሰን', atTime: 'በክስተቱ ሰዓት', fifteen: 'ከ15 ደቂቃ በፊት', hour: 'ከ1 ሰዓት በፊት ከፍተኛ ድምፅ ማንቂያ', day: 'ከ1 ቀን በፊት', noReminder: 'ማስታወሻ የለም', prayerLink: 'ጸሎት በራስ-ሰር ፍጠር', prayerLinkHint: 'AI ከርዕሱና ከክስተቱ ዓይነት የጥንዶች ጸሎት ያዘጋጃል።', prayerPreview: 'የጸሎት ቅድመ እይታ', scripture: 'ቅዱስ ቃል',
  ...
  om: {
    ...
    syncedActivity: 'Sochii hiriyootaa walsimsiifame', syncedActivityHint: 'Yeroon amantii fi hariiroo galmaaʼe kaalaandarii keessan irratti mallatteeffama.', prayerActivity: 'Kadhannaa', devotionalActivity: 'Qoʼannaa guyyaa', qaActivity: 'Gaaffii fi deebii', verseActivity: 'Caqasa qoodame', moodActivity: 'Miira guyyaa', stageActivity: 'Sadarkaa hiriyootaa', devotionalCompleted: 'Qoʼannaan guyyaa xumurame', questionAnswered: 'Gaaffiin deebii argate', moodGreat: 'Baayʼee gammade', moodGood: 'Gaarii natti dhagaʼama', moodOkay: 'Tole natti dhagaʼama', moodSad: 'Gadda natti dhagaʼama', seedStage: 'Sadarkaa Sanyii', growthStage: 'Sadarkaa Guddinaa', unityStage: 'Sadarkaa Tokkummaa', commitmentStage: 'Sadarkaa Waadaa', covenantStage: 'Sadarkaa Kakuu',
